...
describe('4-Igualdad.js', () => {
  ...
  // La igualdad es como un operador lógico, puede comparar mas valores
  ...
  it('vamos a ver algo mas que booleanos', () => {
    // ¡SI! Llego el momento de ver algo mas que true o false.
  ...
  it('la antigua igualdad, que se representa con "=="', () => {
    ...
    // Pero evita utilizarlar todo lo que puedes y usa la nueva.
